            ...
            <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
              ...
              <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                ...
                <div class="relative" x-data="{ open: false }">
                  ...
                  <!-- User dropdown menu -->
                  <div x-cloak x-show="open" x-ref="userMenu" x-transition:enter="transition-all transform ease-out"
          ...
          <div class="flex flex-col h-screen">
            ...
            <div class="flex-1 overflow-hidden hover:overflow-y-auto">
              ...
              <div class="p-4 space-y-4 md:p-8">
                ...
                <div>
                  <button @click="setColors('cyan')" class="w-8 h-8 rounded-full"
                    style="background-color: var(--color-cyan)"></button>
                  <button @click="setColors('teal')" class="w-8 h-8 rounded-full"
                    style="background-color: var(--color-teal)"></button>
                  <button @click="setColors('green')" class="w-8 h-8 rounded-full"
                    style="background-color: var(--color-green)"></button>
                  <button @click="setColors('fuchsia')" class="w-8 h-8 rounded-full"
                    style="background-color: var(--color-fuchsia)"></button>
                  <button @click="setColors('blue')" class="w-8 h-8 rounded-full"
                    style="background-color: var(--color-blue)"></button>
                  <button @click="setColors('violet')" class="w-8 h-8 rounded-full"
